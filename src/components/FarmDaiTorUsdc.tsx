...
import { useAllowance, Allowance } from "src/hooks/allowance";
import { useBalance } from "src/hooks/balance";
import { formatCurrency, useDecimalInput, classes, sleep } from "src/util";
import { useWallet, WalletState } from "src/wallet";
import { RadioGroup, Radio } from "./BasicInput";
import { CoinInput } from "./CoinInput";
import { StaticImg } from "./StaticImg";
import { Submit } from "./Submit";
import { Tabs, Tab } from "./Tab";
import { Transaction, TransactionModal } from "./Transaction";
...
const FarmStats: VFC = () => {
  const [farmStats, setFarmStats] = useState<FarmAggregator.TorStats>();
